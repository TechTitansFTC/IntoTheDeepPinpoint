...
=======
    private final double SHOULDER_L_START = 0.9;//arm in robot

    private final double SHOULDER_R_SCORE = 0.8;//same but with othe arm

    private final double SHOULDER_R_START = 0.1;
>>>>>>> Stashed changes
...
=======
    private final double SHOULDER_L_PULLDOWN = 0.1;
    private final double ELBOW_START= 0.1;
    private final double ELBOW_SCORE= 0.75;
>>>>>>> Stashed changes
